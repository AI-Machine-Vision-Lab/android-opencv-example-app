...
#ifndef _Included_com_opencv_gohn_android_1opencv_MainActivity
#define _Included_com_opencv_gohn_android_1opencv_MainActivity
#ifdef __cplusplus
extern "C"{
#endif
#undef com_opencv_gohn_android_1opencv_MainActivity_PERMISSIONS_REQUEST_CODE
#define ccom_opencv_gohn_android_1opencv_MainActivity_PERMISSIONS_REQUEST_CODE 1000L

    JNIEXPORT jlong JNICALL
    Java_com_opencv_gohn_android_1opencv_MainActivity_loadCascade(JNIEnv *env, jclass type,
    ...
    Java_com_opencv_gohn_android_1opencv_MainActivity_detect(JNIEnv *env, jclass type,
